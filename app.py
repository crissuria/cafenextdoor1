...
def seed_database(cursor):
    ...
    menu_items = [
        ...
        ('Latte', 'Smooth espresso with steamed milk', 165, 'Hot Drinks', '/static/images/menu/Latte_20251219_135530.jpeg'),
        ...
        ('Mocha', 'Espresso with chocolate and steamed milk', 175, 'Hot Drinks', '/static/images/menu/Mocha_20251219_135738.jpg'),
        ...
        ('Cortado', 'Espresso with equal parts warm milk', 145, 'Hot Drinks', '/static/images/menu/Cortado_20251219_135344.jpg'),
        ...
        ('Hot Chocolate', 'Rich and creamy chocolate drink', 135, 'Hot Drinks', '/static/images/menu/Hot_Chocolate_20251219_135437.webp'),
        ...
        ('Matcha Latte', 'Japanese green tea with steamed milk', 170, 'Hot Drinks', '/static/images/menu/Matcha_Latte_20251219_135624.webp'),
        ...
        # Cold Drinks
        ('Iced Coffee', 'Cold brewed coffee over ice', 135, 'Cold Drinks', '/static/images/menu/Iced_Coffee_20251219_134932.jpg'),
        ...
        ('Iced Latte', 'Espresso with cold milk over ice', 165, 'Cold Drinks', '/static/images/menu/Iced_Latte_20251219_135023.webp'),
        ...
        ('Iced Mocha', 'Espresso, chocolate, and cold milk over ice', 175, 'Cold Drinks', '/static/images/menu/Iced_Mocha_20251219_135106.webp'),
        ('Iced Caramel Macchiato', 'Vanilla, espresso, caramel, and ice', 190, 'Cold Drinks', '/static/images/menu/Iced_Caramel_Macchiato_20251219_093606.jpg'),
        ...
        ('Iced Matcha Latte', 'Japanese green tea with cold milk', 170, 'Cold Drinks', '/static/images/menu/Iced_Matcha_Latte_20251219_094104.webp'),
        ...
        ('Iced Chai Latte', 'Spiced tea with cold milk over ice', 145, 'Cold Drinks', '/static/images/menu/Iced_Chai_Latte_20251219_093902.webp'),
        ...
        ('Chocolate Chip Muffin', 'Classic muffin with chocolate chips', 130, 'Pastries', '/static/images/menu/Chocolate_Chip_Muffin_20251219_092049.webp'),
        ('Almond Croissant', 'Buttery croissant with almond filling', 150, 'Pastries', '/static/images/menu/Almond_Croissant_20251219_091208.jpg'),
        ('Danish Pastry', 'Flaky pastry with fruit filling', 145, 'Pastries', '/static/images/menu/Danish_Pastry_20251219_092630.jpg'),
        ('Cinnamon Roll', 'Sweet roll with cinnamon and glaze', 155, 'Pastries', '/static/images/menu/Cinnamon_Roll_20251219_092252.jpg'),
        ...
        ('Scone', 'Traditional British scone with jam', 135, 'Pastries', '/static/images/menu/Scone_20251219_092539.jpg'),
        ('Chocolate Croissant', 'Buttery croissant with chocolate', 150, 'Pastries', '/static/images/menu/Chocolate_Croissant_20251219_092117.webp'),
        ('Apple Turnover', 'Flaky pastry with apple filling', 150, 'Pastries', '/static/images/menu/Apple_Turnover_20251219_091406.jpg'),
        ('Banana Bread', 'Moist homemade banana bread', 140, 'Pastries', '/static/images/menu/Banana_Bread_20251219_091712.webp'),
        ('Donut', 'Classic glazed donut', 100, 'Pastries', '/static/images/menu/Donut_20251219_092602.webp'),
        ...
        ('Chocolate Chip Cookie', 'Warm, gooey chocolate chip cookie', 100, 'Desserts', '/static/images/menu/Chocolate_Chip_Cookie_20251219_095116.jpg'),
        ('Red Velvet Cake', 'Moist red velvet with cream cheese frosting', 190, 'Desserts', '/static/images/menu/Red_Velvet_Cake_20251219_134836.jpg'),
        ('Carrot Cake', 'Spiced carrot cake with cream cheese', 170, 'Desserts', '/static/images/menu/Carrot_Cake_20251219_094423.jpg'),
        ('Lemon Tart', 'Tangy lemon curd in buttery crust', 160, 'Desserts', '/static/images/menu/Lemon_Tart_20251219_134617.webp'),
        ('Chocolate Mousse', 'Light and airy chocolate mousse', 165, 'Desserts', '/static/images/menu/Chocolate_Mousse_20251219_095009.jpg'),
        ('Ice Cream Sundae', 'Vanilla ice cream with toppings', 150, 'Desserts', '/static/images/menu/Ice_Cream_Sundae_20251219_134522.webp'),
        ('Apple Pie', 'Classic apple pie with flaky crust', 170, 'Desserts', '/static/images/menu/Apple_Pie_20251219_135148.webp'),
        ('Pecan Pie', 'Rich pecan pie with caramel', 185, 'Desserts', '/static/images/menu/Pecan_Pie_20251219_134707.webp'),
        ('Key Lime Pie', 'Tart and creamy key lime pie', 170, 'Desserts', '/static/images/menu/Key_Lime_Pie_20251219_134424.webp'),
        
        # Light Meals & Sandwiches
        ('Avocado Toast', 'Smashed avocado on sourdough', 175, 'Light Meals', '/static/images/menu/Avocado_Toast_20251219_093318.jpg'),
        ...
        ('Chicken Panini', 'Grilled chicken panini', 200, 'Light Meals', '/static/images/menu/Chicken_Panini_20251219_135922.jpg'),
        ('Caprese Sandwich', 'Fresh mozzarella, tomato, and basil', 180, 'Light Meals', '/static/images/menu/Caprese_Sandwich_20251219_093158.webp'),
        ('Quiche', 'Savory egg and cheese quiche', 170, 'Light Meals', '/static/images/menu/Quiche_20251219_140011.webp'),
...
def menu():
    ...
    try:
        ...
        try:
            ...
            all_categories = [dict(row)['category'] if isinstance(row, sqlite3.Row) else row['category'] for row in all_categories_rows]
        except:
            all_categories = []
        ...
        if 'customer_id' in session:
            try:
                ...
                favorites = [dict(row)['menu_item_id'] if isinstance(row, sqlite3.Row) else row['menu_item_id'] for row in fav_rows]
            except:
                favorites = []
        ...
        for item in items:
            try:
                ...
                if rating_data:
                    ...
                    item['avg_rating'] = rating_data.get('avg_rating') or 0
                    item['review_count'] = rating_data.get('review_count') or 0
                else:
                    item['avg_rating'] = 0
                    item['review_count'] = 0
            except:
...
def check_rate_limit(ip_address, email, message):
    ...
    ip_submissions_row = conn.execute('''
        SELECT COUNT(*) as count FROM contact_messages 
        WHERE ip_address = ? AND created_at > ?
    ''', (ip_address, one_hour_ago.strftime('%Y-%m-%d %H:%M:%S'))).fetchone()
    ip_submissions = dict(ip_submissions_row).get('count', 0) if isinstance(ip_submissions_row, sqlite3.Row) else (ip_submissions_row[0] if ip_submissions_row else 0)
    ...
    if email:
        email_submissions_row = conn.execute('''
            SELECT COUNT(*) as count FROM contact_messages 
            WHERE email = ? AND created_at > ?
        ''', (email, one_hour_ago.strftime('%Y-%m-%d %H:%M:%S'))).fetchone()
        email_submissions = dict(email_submissions_row).get('count', 0) if isinstance(email_submissions_row, sqlite3.Row) else (email_submissions_row[0] if email_submissions_row else 0)
...
def delete_duplicate_messages(email, message):
    ...
    if len(duplicates) > 1:  # More than one means we have duplicates
        ...
        duplicate_ids = [dict(row)['id'] if isinstance(row, sqlite3.Row) else row['id'] for row in duplicates[1:]]  # Skip the first (most recent)
    ...
    try:
        if request.method == 'POST':
            ...
            try:
                ...
                # Check password
                password_valid = check_password_hash(user_dict.get('password_hash', ''), password)
                print(f"Login attempt for '{username}': Password valid = {password_valid}")
                
                if password_valid:
                    # Set session variables
                    session['user_id'] = user_dict.get('id')
                    session['username'] = user_dict.get('username')
                    ...
                    print(f"Login successful for '{username}' (ID: {user_dict.get('id')}, Role: {session['user_role']})")
...
def customer_login():
    ...
    if request.method == 'POST':
        ...
        if customer:
            ...
            if check_password_hash(customer.get('password_hash', ''), password):
                session['customer_id'] = customer.get('id')
                session['customer_name'] = customer.get('first_name', '')
                session['customer_email'] = customer.get('email', '')
                flash(f'Welcome back, {customer.get("first_name", "Customer")}!', 'success')
    ...
    if cart:
        ...
        for item in cart:
            ...
            if menu_item:
                ...
                cart_item['subtotal'] = float(menu_item.get('price', 0)) * item['quantity']
    ...
    if request.method == 'POST':
        ...
        for cart_item in cart_items:
            ...
            for ing in required_ingredients:
                ...
                ingredient = conn.execute('SELECT current_stock, name FROM ingredients WHERE id = ?', (ingredient_id,)).fetchone()
                if not ingredient:
                    conn.rollback()
                    conn.close()
                    flash(f'Error: Ingredient not found for menu item.', 'error')
                    return redirect(url_for('view_cart'))
                ...
                if current_stock < quantity_needed:
                    conn.rollback()
                    conn.close()
                    flash(f'Insufficient stock for {ingredient["name"]}. Available: {current_stock:.2f}, Required: {quantity_needed:.2f}', 'error')
                    return redirect(url_for('view_cart'))
...
def admin_mark_no_show(order_id):
    ...
    # Convert order Row to dict if needed
    ...
    customer = conn.execute('SELECT * FROM customers WHERE id = ?', (order.get('customer_id'),)).fetchone()
    
    # Convert customer Row to dict if needed
    if customer:
        if not isinstance(customer, dict):
            customer = dict(customer)
        
        # Auto-blacklist after 3 no-shows
        if customer.get('no_show_count', 0) >= 3:
            # Check if already blacklisted
            existing = conn.execute('SELECT * FROM blacklist WHERE customer_id = ?', (order.get('customer_id'),)).fetchone()
            if not existing:
                conn.execute('''
                    INSERT INTO blacklist (customer_id, email, phone, reason, no_show_count)
                    VALUES (?, ?, ?, ?, ?)
                ''', (order.get('customer_id'), customer.get('email', ''), customer.get('phone', ''), 
                      'Multiple no-shows (3+)', customer.get('no_show_count', 0)))
                flash(f'Customer blacklisted due to {customer.get("no_show_count", 0)} no-shows.', 'error')
...
def admin_add_category():
    ...
    conn = get_db_connection()
    existing = conn.execute('SELECT COUNT(*) as count FROM menu_items WHERE category = ?', (category_name,)).fetchone()
...
def admin_delete_category(category_name):
    ...
    item_count_row = conn.execute('SELECT COUNT(*) as count FROM menu_items WHERE category = ?', (category_name,)).fetchone()
    if isinstance(item_count_row, sqlite3.Row):
        item_count = dict(item_count_row).get('count', 0)
    else:
...
@login_required  # Protect debug routes
def debug_db_check():
...
@admin_required  # Protect debug routes - admin only
